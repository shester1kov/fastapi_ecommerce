...
SECRET_KEY = 'c232a64ddbcd57b3c9daac78d82f0274a16dae4f72ef2d7b15f248c9f054389c'
ALGORITHM = 'HS256'
...
async def authentificate_user(db: Annotated[AsyncSession, Depends(get_db)], username: str, password: str):
    ...
    if not user or not bcrypt_context.verify(password, user.hashed_password) or user.is_active == False:
        raise HTTPException(
            ...
            detail='Invalid autentification credentials',
